...
namespace device_simulation
{
    class DeviceSimulation
    {
        ...
        private readonly static string connectionString_Truck = "HostName=arka-test-iot.azure-devices.net;DeviceId=TruckDevice;SharedAccessKey=D1HlCcti1Ty2wlfByYWrxOwCA4ilz97IWgXmS5v9Veg=";
        private readonly static string connectionString_Airplane = "HostName=arka-test-iot.azure-devices.net;DeviceId=AirplaneDevice;SharedAccessKey=R/IcKNh8PWX7z01jl6Xz3UUOTaBoylMnX8fIXWqoQl4=";
        private readonly static string connectionString_Container = "HostName=arka-test-iot.azure-devices.net;DeviceId=ContainerDevice;SharedAccessKey=a+FcQfkLiDtI+pD9Di+cj7G+ag97UnKkWEZvkvHEpUU=";
